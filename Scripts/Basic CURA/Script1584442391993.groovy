...
WebUI.verifyMatch(url, 'https://katalon-demo-cura.herokuapp.com/profile.php#login', false)
...
WebUI.verifyMatch(url, 'https://katalon-demo-cura.herokuapp.com/#appointment', false)
...
WebUI.verifyMatch(url, 'https://katalon-demo-cura.herokuapp.com/appointment.php#summary', false)
...
WebUI.verifyMatch(url, 'https://katalon-demo-cura.herokuapp.com/', false)
